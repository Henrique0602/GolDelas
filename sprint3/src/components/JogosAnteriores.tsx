...
const mapFixtureToPreviousMatch = (fixture: FixtureResponse): PreviousMatch => ({
  id: fixture.fixture.id,
  competition: [fixture.league.country, fixture.league.name, fixture.league.round]
    .filter(Boolean)
    .join(" | "),
  dateLabel: new Date(fixture.fixture.date).toLocaleDateString("pt-BR"),
  home: {
    id: fixture.teams.home.id,
    name: fixture.teams.home.name,
    logo: fixture.teams.home.logo ?? "/Logo.png",
    score: fixture.goals.home ?? fixture.score.fulltime.home ?? 0,
  },
  away: {
    id: fixture.teams.away.id,
    name: fixture.teams.away.name,
    logo: fixture.teams.away.logo ?? "/Logo.png",
    score: fixture.goals.away ?? fixture.score.fulltime.away ?? 0,
  },
});
...
const JogosAnteriores = () => {
    ...
    const loadPreviousMatches = async () => {
      ...
      try {
        ...
        if (err instanceof Error) {
          ...
          setError("Erro desconhecido ao buscar jogos anteriores.");
        }
      } finally {
        if (isMounted) {
          setLoading(false);
  ...
  return (
    <section className="p-4">
      ...
      {loading && <p className="text-gray-400 text-sm">Carregando jogos anteriores...</p>}

      {error && (
        <p className="text-red-400 text-sm">Nao foi possivel carregar os jogos anteriores. {error}</p>
      )}

      {!loading && !error && matches.length === 0 && (
        <p className="text-gray-400 text-sm">
          Ainda nao encontramos jogos finalizados para os filtros configurados.
        </p>
      )}
