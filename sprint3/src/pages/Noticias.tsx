...
const noticias: Noticia[] = [
  ...
  },
  {
    id: 2,
    titulo:
      "Final da Copa do Brasil Feminina tem recorde de público e audiência: O Brasil está assistindo",
    imagem: "/Noticia2.png",
    descricao:
  ...
  },
  {
    id: 3,
    titulo:
      "Ex-volante da Seleção se junta a projeto social para formar futuras craques na periferia de Recife",
    imagem: "/Noticia3.png",
    descricao:
  ...
  },
  {
    id: 4,
    titulo:
      "Gol de bicicleta aos 92 minutos garante título inédito para o Bahia no Nordestão Feminino",
    imagem: "/noticia4.png",
    descricao: "O Nordestão Feminino teve um desfecho de cinema neste domingo."
  },
  {
    id: 5,
    titulo:
      "Técnica do Avaí/Kindermann inova com linha de 3 zagueiras e garante classificação inédita à Libertadores",
    imagem: "/noticia5.png",
    descricao:
  ...
  return (
    <section className="bg-black text-white min-h-screen">
      ...
      <main className="p-4 space-y-6">
        <h2 className="text-yellow-400 text-lg font-bold mb-6">NOTÍCIAS</h2>
          ...
          {noticias.map((noticia) => (
            ...
            >
              ...
              <div className="p-4 flex flex-col flex-grow">
                ...
                <p className="text-sm text-gray-300 flex-grow">{noticia.descricao}</p>
