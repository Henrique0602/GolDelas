...
const times: Team[] = [
  ...
  { nome: "Ferroviária", logo: "/Ferroviaria.png" },
  { nome: "América Mineiro", logo: "/AmericaMineiro.png" },
  { nome: "Grêmio", logo: "/Gremio.png" },
...
const Interesse = () => {
  const handleSelectTeam = (team: Team) => {
    ...
    window.alert(`${team.nome} foi selecionado! Vá para Perfil.`);
  };
